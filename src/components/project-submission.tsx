...
export function ProjectSubmission({
    ...
    // Show reviewed status with rating and feedback
    ...
    // Show submitted but pending review status
    if (isCompleted && existingLink && !isReviewed) {
        return (
            <div className="space-y-4">
                <div className="p-6 bg-green-50 dark:bg-green-900/10 border-2 border-green-200 dark:border-green-900/30 rounded-2xl shadow-sm">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h3 className="font-bold text-green-800 dark:text-green-300">Project Submitted - Pending Review</h3>
                    </div>
                    <p className="text-sm text-green-700 dark:text-green-400 ml-9">
                        <span className="font-medium">Current Link:</span> <a href={existingLink} target="_blank" rel="noopener noreferrer" className="underline break-all hover:text-green-600 transition-colors">{existingLink}</a>
                    </p>
                    <p className="text-xs text-green-600/70 mt-2 ml-9 italic">You can update your submission below until an instructor reviews it.</p>
                </div>

                {/* Allow updates */}
                <div className="p-6 border-2 border-dashed rounded-2xl bg-card/50">
                    <h4 className="text-lg font-bold mb-4">Update Submission</h4>
