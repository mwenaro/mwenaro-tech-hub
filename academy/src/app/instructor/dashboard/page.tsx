                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-12">
                    <Card className="p-6 bg-gradient-to-br from-primary/10 to-transparent border-primary/20">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm font-bold uppercase tracking-widest text-primary mb-1">Total Revenue</p>
                                <p className="text-4xl font-black">KSh {stats.totalRevenue.toLocaleString()}</p>
                            </div>
                            <div className="p-3 bg-primary rounded-xl shadow-lg shadow-primary/20 text-white">
