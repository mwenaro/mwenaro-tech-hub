                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm font-medium text-secondary-foreground opacity-70">
                            ...
                            <li><span>+254 700 123 456</span></li>
                        </ul>
                    </div>
                    ...
                    <div className="glass-card !bg-white/5 p-8 rounded-3xl border-white/10">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            />
                            <button className="bg-primary text-white py-3 rounded-xl text-sm font-bold hover:brightness-110 active:scale-[0.98] transition-all shadow-lg shadow-primary/20">
                                Join Now
                            </button>
                        </div>
                    </div>
